...
import { addTaskToFavorites, getTaskBySubCategory, getUserInfo } from "../../api";
  ...
  useEffect(() => {
    ...
    const fetchTasks = async () => {
      try {
        ...
        const response = await getTaskBySubCategory(subCategoryName);
